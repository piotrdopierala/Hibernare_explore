...
public class DeleteApp {
    public static void main(String[] args) {
        ...
        ////////////////////
        Integer idEmployeeToRemove = 115;

        String deleteSQL = "DELETE Employee WHERE idEmployee=:idEmpToDelete";

        Query query = currentSession.createQuery(deleteSQL)
                .setParameter("idEmpToDelete", idEmployeeToRemove);
        query.executeUpdate();
